---
title: "NKLegacy x86 Memory Map and Linker Layout"
...
0x08000 – 0x08FFF    (grows ↓)    Real-mode stack (SP starts at 0x7C00 in Stage 1)
0x09000                           Stack top for Multiboot / Stage 2 32-bit entry
