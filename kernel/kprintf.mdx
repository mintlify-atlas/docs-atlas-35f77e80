...
description: "Reference for kprintf, the NKLegacy formatted print function. Documents all supported format specifiers and how output is mirrored to both VGA and COM1 serial."
---
