---
title: "GDT and IDT: Protected Mode Descriptor Tables"
sidebarTitle: "GDT & IDT"
description: "How NKLegacy sets up the x86 Global Descriptor Table and Interrupt Descriptor Table, including segment selectors, entry structures, and initialization functions."
---
...
static void my_keyboard_handler(registers_t *regs) {
    ...
    pic_send_eoi(1);  /* IRQ line 1 = keyboard */
}
