---
title: "NKLegacy Shell Commands: Complete NT-Style Reference"
...
| Message | Trigger |
|---------|---------|
| `'<cmd>' is not recognized as an internal or external command,`<br/>`operable program or batch file.` | The input does not match any built-in command. |
