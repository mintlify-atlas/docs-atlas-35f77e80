---
title: "PE Loader: Running PE32 Binaries Inside the Kernel"
sidebarTitle: "PE Loader"
description: "NKLegacy PE loader: MZ/PE signature checks, machine type validation, section mapping, and direct entry point invocation via pe_load_and_run."
---
